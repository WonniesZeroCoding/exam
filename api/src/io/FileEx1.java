...
public class FileEx1 {
	public static void main(String[] args) throws IOException {
		//파일 객체 생성  
		// \t, \n
		File f1 = new File("D:\\Coding & Java & Python 수업\\Temp\\test1.txt");
		File f2 = new File("D:\\Coding & Java & Python 수업\\Temp","test1.txt");
		File dir = new File("D:\\Coding & Java & Python 수업\\Temp");
