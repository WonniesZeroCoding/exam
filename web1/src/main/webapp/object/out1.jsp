...
<%--
    	...
    	4) HttpSession session : http 프로토콜의 연결 방식은 stateless를 보완하기 위해 사용
    	5) ServletContext application : 서버 측 정보와 서버측 자원에 대한 정보 및 해당 애플리케이션의 이벤트 로그를 다루는 객체
    	6) JspWriter out : 자바 변수를 화면 출력시 사용
    	7) Object page : 현재 서비스 되고 있는
--%>
<!DOCTYPE html>
<html>
<head>
